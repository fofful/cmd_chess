...
impl Board {
    ...
    pub fn draw_board(&mut self, pawns: &Vec<&mut Pawn>) {
        ...
        for row in &mut self.table {
            row.iter_mut().for_each(|pos| *pos = empty.clone());
        }
        ...
        for pawn in pawns {
            ...
            if is_live {
                self.table[position.0][position.1] = format!(
                    "{}{}{}",
                    color.to_string(),
                    class.to_string(),
                    "\x1B[38;5;130m"
        ...
        println!("\x1B[38;5;130m  |  1 |  2 |  3 |  4 |  5 |  6 |  7 |  8 |\x1B[0m");
        println!("\x1B[38;5;130m  .---------------------------------------.\x1B[0m");
        println!(
            "\x1B[38;5;130m|A| {} | {} | {} | {} | {} | {} | {} | {} |\x1B[0m",
            self.table[0][0],
            self.table[0][1],
            self.table[0][2],
            self.table[0][3],
